...
<div class="credit-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'doc_date_start',
            'value' => function ($data) {
                return $data->doc_date_start; //Yii::$app->formatter->asDate($data->doc_date_start, "php:d.m.Y");
            },
            'contentOptions' => ['style' => 'width:70px'],
        ],
        [
            'attribute' => 'doc_date_end',
            'value' => function ($data) {
                return $data->doc_date_end; //Yii::$app->formatter->asDate($data->doc_date_end, "php:d.m.Y");
            },
            'contentOptions' => ['style' => 'width:70px'],
        ],
        [
        ...
        [
            'attribute' => 'client_birthday',
            'header' => ($lang == 'ru') ? 'Дата рождения' : 'Tug`ilgan Sana',
            'value' => function ($data) {
        ...
        [
            ...
            'value' => function ($data) {
                return Yii::$app->params['credit_status'][Yii::$app->language][$data->credit_status];
            },
            'filter' => Yii::$app->params['credit_status'][$lang],
        ],
        [
