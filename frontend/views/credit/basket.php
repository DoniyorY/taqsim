...
<div class="credit-index">
    ...
    $gridColumns = [
        [
            ...
            'format' => 'html',
            'value' => function ($data) {
                $end = Yii::$app->formatter->asDate($data->doc_date_end, "php:d.m.Y");
                return '№ ' . $data->id;
            },
        ...
        [
            ...
            'value' => function ($data) {
                return Yii::$app->formatter->asDate($data->doc_date_start, "php:d.m.Y");
            },
            'contentOptions' => ['style' => 'width:70px'],
        ],
        [
            ...
            'value' => function ($data) {
                return Yii::$app->formatter->asDate($data->doc_date_end, "php:d.m.Y");
            },
            'contentOptions' => ['style' => 'width:70px'],
        ],
        [
        ...
        [
            ...
            'value' => function ($data) {
                return Html::a(Yii::$app->params['delete_forever'][Yii::$app->language], ['/credit/delete-all', 'id' => $data->id], ['class' => 'btn btn-sm btn-danger']);
            },
            'format' => 'raw',
        ],
        [
