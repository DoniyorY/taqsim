            ...
            foreach ($company as $com_one): ?>
                ...
                <tr class="<?php echo ($credit_plan_summa <= 0) ? 'table-danger' : ''; ?>">
                    ...
                    <td style="border: 1px solid #000">
                        ...
                        <?= Yii::$app->formatter->asDecimal($credit_plan_summa + $prepaid_summa, 0);
                        $total1 = $total1 + $credit_plan_summa + $prepaid_summa; ?>
                    </td>
                    <td style="border: 1px solid #000">
                        ...
                        $payments_summa = \common\models\Payments::find()
                            ...
                            ->sum('amount');
                        ?>
                        <?= Yii::$app->formatter->asDecimal($payments_summa + $prepaid_summa, 0);
                        $total2 = $total2 + $payments_summa + $prepaid_summa; ?>
                    </td>

                    <td style="border: 1px solid #000">
                        <?php $res = $credit_plan_summa - $payments_summa; ?>
                        <?= Yii::$app->formatter->asDecimal($res);
