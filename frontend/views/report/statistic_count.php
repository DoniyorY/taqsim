...
<div class="statistic-count">
   ...
   <?php ActiveForm::end(); ?>
    ...
    <ul class="nav nav-tabs mt-3 mb-2" id="statistic-count-tabs" role="tablist" aria-label="Навигация по таблицам">
        <li class="nav-item">
            <a href="#credit-count-tab" class="nav-link active" role="tab" data-tab-target="credit-count-tab">Количество
                кредитов</a>
        </li>
        <li class="nav-item">
            <a href="#contract-sum-tab" class="nav-link" role="tab" data-tab-target="contract-sum-tab">Сумма
                договоров</a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content">
        <div class="tab-pane active mt-2" id="credit-count-tab" role="tabpanel">
            ...
            <table class="table table-sm table-striped table-bordered text-center" border="1"
        ...
        <div class="tab-pane mt-2" id="contract-sum-tab" role="tabpanel">
            ...
            <table class="table table-sm table-striped table-bordered text-center" border="1"
                   id="tbl_contract_exporttable_to_xls">
                <thead>
                <tr>
                    <th style="border: 1px solid #000"></th>
                    <th style="border: 1px solid #000" colspan="<?= count($contractMonthCounts) + 1 ?>">Количество
                        месяцев
                    </th>
                </tr>
                <tr>
        ...
        <div class="tab-pane mt-2" id="payment-sum-tab" role="tabpanel">
            ...
            <table class="table table-sm table-striped table-bordered text-center" border="1"
                   id="tbl_payment_exporttable_to_xls">
                <thead>
                <tr>
                    <th style="border: 1px solid #000"></th>
                    <th style="border: 1px solid #000" colspan="<?= count($paymentMonthCounts) + 1 ?>">Количество
                        месяцев
                    </th>
                </tr>
                <tr>
